    ...
    try {
      ...
      tx.moveCall({
        ...
        arguments: [
          ...
          // en/zh/ja (scoring/score.ts calculateLanguageStability) - this
          // field was written as a hardcoded 100 while the suite was
          // English-only. Already u8-safe: the score is clamped to 0-100 and
          // rounded before it gets here.
